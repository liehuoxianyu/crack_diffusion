...
# ========== 数据加载配置（Appearance + updated prompts） ==========
export CRACK_JSONL="/CrackTree260/train_linux_updated.jsonl"
export CRACK_COND_DIR="/CrackTree260/cond_appearance"
export CRACK_CROP_COND_DIR="/CrackTree260/cond_mask"

# patch 策略：裁剪评分使用 binary mask，appearance 条件只作为 ControlNet 输入
...
export OUTPUT_DIR="/work/outputs/exp_APPEARANCE_patch512"
...
accelerate launch train_controlnet.py \
  ...
  --validation_image "/CrackTree260/cond_appearance/6192.png" \
